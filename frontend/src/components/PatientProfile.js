                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-2">
                      ...
                      {submitResult.ai_interpretation && (
						  <div className="bg-white bg-opacity-60 p-5 rounded-lg border border-gray-200 mt-4 shadow-inner">
							<h4 className="text-sm font-bold text-gray-800 flex items-center gap-2 mb-3">
							  <span className="text-xl">🤖</span> AI Clinical Analysis
							</h4>
							...
							<div className="text-sm text-gray-700 leading-relaxed">
							  <ReactMarkdown 
								components={{
								  ...
								  strong: ({node, ...props}) => <span className="font-bold text-teal-900" {...props} />
								}}
							  >
								{submitResult.ai_interpretation}
							  </ReactMarkdown>
							...
							<p className="text-xs text-gray-400 mt-3 text-right italic">
							  Generated by Hybrid AI (NEWS2 + Gemini)
							</p>
						  </div>
						)}
                    </div>
					...
					{!showVitalsForm ? (
					  <div className="flex justify-start mb-6">
						<button
						  ...
						  shadow-sm flex items-center gap-2 hover:shadow-md"
						>
